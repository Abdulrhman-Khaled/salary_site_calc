...
def get_columns(earning_types, ded_types):
	columns = [
		...
		{"label": _("Leave Without Pay"), "fieldname": "leave_without_pay", "fieldtype": "Float", "width": 100},
		...
		{"label": _("Days in Office"), "fieldname": "custom_days_on_office", "fieldtype": "Float", "width": 100},
		{"label": _("Site Total"), "fieldname": "custom_total_site", "fieldtype": "Currency", "options": "currency", "width": 120},
		{"label": _("Office Total"), "fieldname": "custom_total_office", "fieldtype": "Currency", "options": "currency", "width": 120},
	]
...
def get_salary_slip_details(salary_slips, currency, company_currency, component_type):
	...
	result = (
		...
		.join(salary_detail).on(salary_slip.name == salary_detail.parent)
